...
function Home() {
  return (
    ...
    <Flex
      ...
      justify="center"
      bg="#FBFBFB"
      height="115vh" // Set the height to 100% of the viewport height
    >
      <Header/>
      <HStack pl="150px " pr="138px">
     
        <VStack display="flex" align="left" spacing={4} style={{ marginTop: '-70px' }} >
        ...
        {/* Right Side: Image */}
        <Image height="600px" width="800px" style={{ marginTop: '-70px' }} src={eyes} alt="Logo" />
